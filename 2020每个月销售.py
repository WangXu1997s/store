...
wb = xlrd.open_workbook(filename=r'C:\Users\LENOVO\Desktop\python\day9\任务\2020年每个月的销售情况.xlsx',encoding_override=True)
#
...
#                 sum3 = data3
#                 d = k
# print('第一个季度销售',list[a])
# print('第二个季度销售',list[b])
# print('第三个季度销售',list[c])
# print('第四个季度销售',list[d])
# 每个季度的销量冠军
