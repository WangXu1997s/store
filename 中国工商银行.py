        ...
        while True:
            ...
            if password == date1:
                ...
                if withdraw_money > date2:
                    ...
                    sal3='update user set money =money-%s where account=%s'
...
def saving():
    ...
    if len(date)>0:
        ...
        sal1='update user set money=money+%s where account=%s'
            ...
            while True:
                if password == date2:
                    ...
                    if money>date3:
                        ...
                        sal4='update user set money=money-%s where account=%s'
                        param4=[money,account]
                        update(sal4,param4)
                        sal5='select money from user where account=%s'
                        param5=[account]
                        date4=select(sal5,param5)
                        sal6='update user set money=money+%s where account=%s'
                        param6=[money,account]
                        update(sal6,param6)
